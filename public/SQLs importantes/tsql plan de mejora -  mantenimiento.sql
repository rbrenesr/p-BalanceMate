...
IF EXISTS(SELECT 1 FROM sys.objects WHERE name = 'spEXECsp_RECOMPILE')        
    DROP PROCEDURE swe.spEXECsp_RECOMPILE
GO

CREATE PROCEDURE swe.spEXECsp_RECOMPILE AS 
/*
----------------------------------------------------------------------------
-- Object Name: swe.spEXECsp_RECOMPILE 
...
-- 002 | N\A | 05.07.2012		| JKadlec		| Updated code for SQL Server 2008 R2 o superior
*/
...
DECLARE @RC int
EXECUTE @RC = [swe].[spEXECsp_RECOMPILE] 
GO
